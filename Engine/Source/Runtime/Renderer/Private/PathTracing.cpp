...
public:
	...
	static bool ShouldCompilePermutation(const FMeshMaterialShaderPermutationParameters& Parameters)
	{
		...
		if (UseIntersectionShader != bUseProceduralPrimitive)
		{
	  	...
	  	//@EGPU 5.3 this patch comes from the commit to fix shaders
		//@EGPU 5.3 https://github.com/EpicGames/UnrealEngine/commit/c05ce7ab40ca5e4828d2d95443323d1ef8accd3e
